from pcpi_candidate_tas.theory_status import one_sided_theory_status, one_sided_theory_status
...
def test_prior_art_and_code_mapping_are_explicit():
    ...
    assert status.candidate_specific_dominance_cone_information_is_intended_contribution
